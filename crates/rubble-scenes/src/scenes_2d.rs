...
pub fn scene_empty() -> Vec<RigidBodyDesc2D> {
    Vec::new()
}

pub fn scene_ground() -> Vec<RigidBodyDesc2D> {
    vec![rect_desc(0.0, 0.0, 100.0, 1.0, 0.0, 0.0, 0.5)]
}

pub fn scene_dynamic_friction() -> Vec<RigidBodyDesc2D> {
...
pub fn scene_static_friction() -> Vec<RigidBodyDesc2D> {
...
pub fn scene_pyramid() -> Vec<RigidBodyDesc2D> {
    const SIZE: usize = 20;
...
pub fn scene_cards() -> Vec<RigidBodyDesc2D> {
...
pub fn scene_stack() -> Vec<RigidBodyDesc2D> {
    let mut descs = vec![rect_desc(0.0, 0.0, 100.0, 1.0, 0.0, 0.0, 0.5)];
    for i in 0..20 {
        descs.push(rect_desc(
            0.0,
...
pub fn scene_stack_ratio() -> Vec<RigidBodyDesc2D> {
    let mut descs = vec![rect_desc(0.0, 0.0, 100.0, 1.0, 0.0, 0.0, 0.5)];
...
pub fn scene_scatter() -> Vec<RigidBodyDesc2D> {
